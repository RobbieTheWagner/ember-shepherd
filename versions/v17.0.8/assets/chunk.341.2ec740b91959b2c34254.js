(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[341],{9341:(e,t,s)=>{"use strict"
s.r(t),s.d(t,{BUNDLED_LANGUAGES:()=>o,BUNDLED_THEMES:()=>r,FontStyle:()=>p,getHighlighter:()=>te,loadTheme:()=>E,renderToHtml:()=>X,setCDN:()=>x,setOnigasmWASM:()=>se,setWasm:()=>A,toShikiTheme:()=>O})
var a=s(3616),n=s(6536)
...
r=16*r+t-97+10}a++,n++}return n<t&&(r=-1),r}function m(){if(n="",p=0,r=a,c=i,u=l,a>=s)return r=s,o=17
let t=e.charCodeAt(a)
if(y(t)){do{a++,n+=String.fromCharCode(t),t=e.charCodeAt(a)}while(y(t))
return o=15}if(b(t))return a++,n+=String.fromCharCode(t),13===t&&10===e.charCodeAt(a)&&(a++,n+="\n"),i++,l=a,o=14
...
case 34:return a++,n=function(){let t="",n=a
for(;;){if(a>=s){t+=e.substring(n,a),p=2
break}const r=e.charCodeAt(a)
if(34===r){t+=e.substring(n,a),a++
break}if(92!==r){if(r>=0&&r<=31){if(b(r)){t+=e.substring(n,a),p=2
...
break
default:p=5}n=a}}return t}(),o=10
case 47:const c=a-1
if(47===e.charCodeAt(a+1)){for(a+=2;a<s&&!b(e.charCodeAt(a));)a++
return n=e.substring(c,a),o=12}if(42===e.charCodeAt(a+1)){a+=2
const t=s-1
let r=!1
for(;a<t;){const t=e.charCodeAt(a)
if(42===t&&47===e.charCodeAt(a+1)){a+=2,r=!0
break}a++,b(t)&&(13===t&&10===e.charCodeAt(a)&&a++,i++,l=a)}return r||(a++,p=1),n=e.substring(c,a),o=13}return n+=String.fromCharCode(t),a++,o=16
case 45:if(n+=String.fromCharCode(t),a++,a===s||!_(e.charCodeAt(a)))return o=16
case 48:case 49:case 50:case 51:case 52:case 53:case 54:case 55:case 56:case 57:return n+=function(){let t=a
if(48===e.charCodeAt(a))a++
else for(a++;a<e.length&&_(e.charCodeAt(a));)a++
if(a<e.length&&46===e.charCodeAt(a)){if(a++,!(a<e.length&&_(e.charCodeAt(a))))return p=3,e.substring(t,a)
for(a++;a<e.length&&_(e.charCodeAt(a));)a++}let s=a
if(a<e.length&&(69===e.charCodeAt(a)||101===e.charCodeAt(a)))if(a++,(a<e.length&&43===e.charCodeAt(a)||45===e.charCodeAt(a))&&a++,a<e.length&&_(e.charCodeAt(a))){for(a++;a<e.length&&_(e.charCodeAt(a));)a++
s=a}else p=3
return e.substring(t,s)}(),o=11
default:for(;a<s&&d(t);)a++,t=e.charCodeAt(a)
if(r!==a){switch(n=e.substring(r,a),n){case"true":return o=8
case"false":return o=9
case"null":return o=7}return o=16}return n+=String.fromCharCode(t),a++,o=16}}function d(e){if(y(e)||b(e))return!1
switch(e){case 125:case 93:case 123:case 91:case 34:case 58:case 44:case 47:return!1}return!0}return{setPosition:function(e){a=e,n="",r=0,o=16,p=0},getPosition:()=>a,scan:t?function(){let e
do{e=m()}while(e>=12&&e<=15)
return e}:m,getToken:()=>o,getTokenValue:()=>n,getTokenOffset:()=>r,getTokenLength:()=>a-r,getTokenStartLine:()=>c,getTokenStartCharacter:()=>r-u,getTokenError:()=>p}}(e,!1),n=[]
function r(e){return e?()=>e(a.getTokenOffset(),a.getTokenLength(),a.getTokenStartLine(),a.getTokenStartCharacter()):()=>!0}function o(e){return e?()=>e(a.getTokenOffset(),a.getTokenLength(),a.getTokenStartLine(),a.getTokenStartCharacter(),(()=>n.slice())):()=>!0}function i(e){return e?t=>e(t,a.getTokenOffset(),a.getTokenLength(),a.getTokenStartLine(),a.getTokenStartCharacter()):()=>!0}function l(e){return e?t=>e(t,a.getTokenOffset(),a.getTokenLength(),a.getTokenStartLine(),a.getTokenStartCharacter(),(()=>n.slice())):()=>!0}const u=o(t.onObjectBegin),p=l(t.onObjectProperty),h=r(t.onObjectEnd),m=o(t.onArrayBegin),d=r(t.onArrayEnd),g=l(t.onLiteralValue),f=i(t.onSeparator),N=r(t.onComment),k=i(t.onError),L=s&&s.disallowComments,S=s&&s.allowTrailingComma
function P(){for(;;){const e=a.scan()
switch(a.getTokenError()){case 4:v(14)
break
case 5:v(15)
break
case 3:v(13)
...
case 2:v(12)
break
case 6:v(16)}switch(e){case 12:case 13:L?v(10):N()
break
case 16:v(1)
break
case 15:case 14:break
default:return e}}}function v(e,t=[],s=[]){if(k(e),t.length+s.length>0){let e=a.getToken()
for(;17!==e;){if(-1!==t.indexOf(e)){P()
break}if(-1!==s.indexOf(e))break
e=P()}}}function j(e){const t=a.getTokenValue()
return e?g(t):(p(t),n.push(t)),P(),!0}P(),17===a.getToken()?s.allowEmptyContent||v(4,[],[]):function e(){switch(a.getToken()){case 3:return function(){m(),P()
let t=!0,s=!1
for(;4!==a.getToken()&&17!==a.getToken();){if(5===a.getToken()){if(s||v(4,[],[]),f(","),P(),4===a.getToken()&&S)break}else s&&v(6,[],[])
t?(n.push(0),t=!1):n[n.length-1]++,e()||v(4,[],[4,5]),s=!0}return d(),t||n.pop(),4!==a.getToken()?v(8,[4],[]):P(),!0}()
case 1:return function(){u(),P()
let t=!1
for(;2!==a.getToken()&&17!==a.getToken();){if(5===a.getToken()){if(t||v(4,[],[]),f(","),P(),2===a.getToken()&&S)break}else t&&v(6,[],[]);(10!==a.getToken()?(v(3,[],[2,5]),!1):(j(!1),6===a.getToken()?(f(":"),P(),e()||v(4,[],[2,5])):v(5,[],[2,5]),n.pop(),!0))||v(4,[],[2,5]),t=!0}return h(),2!==a.getToken()?v(7,[2],[]):P(),!0}()
case 10:return j(!0)
default:return function(){switch(a.getToken()){case 11:const e=a.getTokenValue()
let t=Number(e)
isNaN(t)&&(v(2),t=0),g(t)
break
case 7:g(null)
...
case 9:g(!1)
break
default:return!1}return P(),!0}()}}()?17!==a.getToken()&&v(9,[],[]):v(4,[],[])}(e,{onObjectBegin:()=>{const e={}
o(e),r.push(n),n=e,a=null},onObjectProperty:e=>{a=e},onObjectEnd:()=>{n=r.pop()},onArrayBegin:()=>{const e=[]
o(e),r.push(n),n=e,a=null},onArrayEnd:()=>{n=r.pop()},onLiteralValue:o,onError:(e,s,a)=>{t.push({error:e,offset:s,length:a})}},s),n[0]}
var k
!function(e){e[e.InvalidSymbol=1]="InvalidSymbol",e[e.InvalidNumberFormat=2]="InvalidNumberFormat",e[e.PropertyNameExpected=3]="PropertyNameExpected",e[e.ValueExpected=4]="ValueExpected",e[e.ColonExpected=5]="ColonExpected",e[e.CommaExpected=6]="CommaExpected",e[e.CloseBraceExpected=7]="CloseBraceExpected",e[e.CloseBracketExpected=8]="CloseBracketExpected",e[e.EndOfFileExpected=9]="EndOfFileExpected",e[e.InvalidCommentToken=10]="InvalidCommentToken",e[e.UnexpectedEndOfComment=11]="UnexpectedEndOfComment",e[e.UnexpectedEndOfString=12]="UnexpectedEndOfString",e[e.UnexpectedEndOfNumber=13]="UnexpectedEndOfNumber",e[e.InvalidUnicode=14]="InvalidUnicode",e[e.InvalidEscapeCharacter=15]="InvalidEscapeCharacter",e[e.InvalidCharacter=16]="InvalidCharacter"}(k||(k={}))
const L="undefined"!=typeof self&&void 0!==self.WorkerGlobalScope,S="process"in globalThis&&"undefined"!=typeof process&&void 0!==process.release&&"node"===process.release.name,P="process"in globalThis&&"undefined"!=typeof process&&void 0!==process.release&&"bun"===process.release.name,v=L||!S&&!P
let j="",C=""
const w="dist/"
function x(e){j=e.endsWith("/")?e:e+"/"}function A(e){C=e}let T=null
function R(e){if(v)return`${j}${e}`
{const t=s(5979)
return t.isAbsolute(e)?e:t.resolve(__dirname,"..",e)}}async function I(e){const t=[],a=await async function(e){const t=R(e)
if(v)return await fetch(t).then((e=>e.text()))
{const e=s(9727)
return await e.promises.readFile(t,"utf-8")}}(e)
let n
try{n=JSON.parse(a)}catch(e){if(n=N(a,t,{allowTrailingComma:!0}),t.length)throw t[0]}return n}async function E(e){const t=O(await I(e))
if(t.include){const s=await E(f(...g(e),t.include))
s.settings&&(t.settings=s.settings.concat(t.settings)),s.bg&&!t.bg&&(t.bg=s.bg),s.colors&&(t.colors={...s.colors,...t.colors}),delete t.include}return t}function O(e){const t=e.type||"dark",s={name:e.name,type:t,...e,...G(e)}
var a
return e.include&&(s.include=e.include),e.tokenColors&&(s.settings=e.tokenColors,delete s.tokenColors),(a=s).settings||(a.settings=[]),a.settings[0]&&a.settings[0].settings&&!a.settings[0].scope||a.settings.unshift({settings:{foreground:a.fg,background:a.bg}}),s}const M={light:"#333333",dark:"#bbbbbb"},B={light:"#fffffe",dark:"#1e1e1e"}
function G(e){let t,s,a=e.settings?e.settings:e.tokenColors
const n=a?a.find((e=>!e.name&&!e.scope)):void 0
return n?.settings?.foreground&&(t=n.settings.foreground),n?.settings?.background&&(s=n.settings.background),!t&&e?.colors?.["editor.foreground"]&&(t=e.colors["editor.foreground"]),!s&&e?.colors?.["editor.background"]&&(s=e.colors["editor.background"]),t||(t="light"===e.type?M.light:M.dark),s||(s="light"===e.type?B.light:B.dark),{fg:t,bg:s}}class F{constructor(e,t){this.languagesPath="languages/",this.languageMap={},this.scopeToLangMap={},this._onigLibPromise=e,this._onigLibName=t}get onigLib(){return this._onigLibPromise}getOnigLibName(){return this._onigLibName}getLangRegistration(e){return this.languageMap[e]}async loadGrammar(e){const t=this.scopeToLangMap[e]
if(!t)return null
...
return t.grammar=s,s}addLanguage(e){this.languageMap[e.id]=e,e.aliases&&e.aliases.forEach((t=>{this.languageMap[t]=e})),this.scopeToLangMap[e.scopeName]=e}}function D(e,t){let s=[]
...
U(c[c.length-1],c.slice(0,c.length-1),t,s)&&(a[n++]=i,e=r)}}return a}var q=["black","red","green","yellow","blue","magenta","cyan","white","brightBlack","brightRed","brightGreen","brightYellow","brightBlue","brightMagenta","brightCyan","brightWhite"],H={1:"bold",2:"dim",3:"italic",4:"underline",7:"reverse",9:"strikethrough"}
...
const Q={pre:({className:e,style:t,children:s})=>`<pre class="${e}" style="${t}" tabindex="0">${s}</pre>`,code:({children:e})=>`<code>${e}</code>`,line:({className:e,children:t})=>`<span class="${e}">${t}</span>`,token:({style:e,children:t})=>`<span style="${e}">${t}</span>`}
function X(e,t={}){const s=t.bg||"#fff",a=function(e){const t=new Map
for(const s of e){const e=s.line
t.has(e)?t.get(e).push(s):t.set(e,[s])}return t}(t.lineOptions??[]),n=t.elements||{}
function r(e="",t={},s){const a=n[e]||Q[e]
...
return r("line",{className:function(e){const t=new Set(["line"])
for(const s of e)for(const e of s.classes??[])t.add(e)
return Array.from(t)}(a.get(o)??[]).join(" "),lines:e,line:s,index:n},s.map(((e,a)=>{const n=[`color: ${e.color||t.fg}`]
return e.fontStyle&p.Italic&&n.push("font-style: italic"),e.fontStyle&p.Bold&&n.push("font-weight: bold"),e.fontStyle&p.Underline&&n.push("text-decoration: underline"),r("token",{style:n.join("; "),tokens:s,token:e,index:a},[(o=e.content,o.replace(/[&<>"']/g,(e=>Y[e])))])
var o})))})))])}const Y={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"}
class Z extends n.Registry{constructor(e){super(e),this._resolver=e,this.themesPath="themes/",this._resolvedThemes={},this._resolvedGrammars={},this._langGraph=new Map,this._langMap=o.reduce(((e,t)=>(e[t.id]=t,e)),{})}getTheme(e){return"string"==typeof e?this._resolvedThemes[e]:e}async loadTheme(e){return"string"==typeof e?(this._resolvedThemes[e]||(this._resolvedThemes[e]=await E(`${this.themesPath}${e}.json`)),this._resolvedThemes[e]):((e=O(e)).name&&(this._resolvedThemes[e.name]=e),e)}async loadThemes(e){return await Promise.all(e.map((e=>this.loadTheme(e))))}getLoadedThemes(){return Object.keys(this._resolvedThemes)}getGrammar(e){return this._resolvedGrammars[e]}async loadLanguage(e){const t=e.embeddedLangs?.reduce((async(e,t,s)=>{if(!this.getLoadedLanguages().includes(t)&&this._resolver.getLangRegistration(t))return await this._resolver.loadGrammar(this._resolver.getLangRegistration(t).scopeName),e[this._resolver.getLangRegistration(t).scopeName]=s+2,e}),{}),s={embeddedLanguages:t,balancedBracketSelectors:e.balancedBracketSelectors||["*"],unbalancedBracketSelectors:e.unbalancedBracketSelectors||[]},a=await this.loadGrammarWithConfiguration(e.scopeName,1,s)
...
for(const s of t)await this.loadLanguage(s)}getLoadedLanguages(){return Object.keys(this._resolvedGrammars)}resolveEmbeddedLanguages(e){if(this._langGraph.has(e.id)||this._langGraph.set(e.id,e),e.embeddedLangs)for(const t of e.embeddedLangs)this._langGraph.set(t,this._langMap[t])}}function ee(e){return"string"==typeof e?o.find((t=>t.id===e||t.aliases?.includes(e))):e}async function te(e){const{_languages:t,_themes:r,_wasmPath:i}=function(e){let t=o,s=e.themes||[],a=e.paths?.wasm?e.paths.wasm.endsWith("/")?e.paths.wasm:e.paths.wasm+"/":w
return e.langs&&(t=e.langs.map(ee)),e.theme&&s.unshift(e.theme),s.length||(s=["nord"]),{_languages:t,_themes:s,_wasmPath:a}}(e),c=new F(async function(e){if(!T){let t
if(v)t="string"==typeof C?(0,a.loadWASM)({data:await fetch(R(f(...g(e),"onig.wasm")))}):(0,a.loadWASM)({data:C})
else{const e=s(5979).join(3616,"../onig.wasm"),n=s(9727).readFileSync(e).buffer
t=(0,a.loadWASM)(n)}T=t.then((()=>({createOnigScanner:e=>(0,a.createOnigScanner)(e),createOnigString:e=>(0,a.createOnigString)(e)})))}return T}(i),"vscode-oniguruma"),l=new Z(c)
e.paths?.themes&&(l.themesPath=e.paths.themes.endsWith("/")?e.paths.themes:e.paths.themes+"/"),e.paths?.languages&&(c.languagesPath=e.paths.languages.endsWith("/")?e.paths.languages:e.paths.languages+"/")
const u=(await l.loadThemes(r))[0]
let m
await l.loadLanguages(t)
let d=function(){const e={"#000001":"var(--shiki-color-text)","#000002":"var(--shiki-color-background)","#000004":"var(--shiki-token-constant)","#000005":"var(--shiki-token-string)","#000006":"var(--shiki-token-comment)","#000007":"var(--shiki-token-keyword)","#000008":"var(--shiki-token-parameter)","#000009":"var(--shiki-token-function)","#000010":"var(--shiki-token-string-expression)","#000011":"var(--shiki-token-punctuation)","#000012":"var(--shiki-token-link)"}
...
function y(e){const t=e?l.getTheme(e):u
if(!t)throw Error(`No theme registration for ${e}`)
m&&m.name===t.name||(l.setTheme(t),m=t)
const s=l.getColorMap()
return"css"===t.type&&function(e,t){e.bg=d[e.bg]||e.bg,e.fg=d[e.fg]||e.fg,Object.entries(e.colors).forEach((([t,s])=>{e.colors[t]=d[s]||s})),t.forEach(((e,s)=>{t[s]=d[e]||e}))}(t,s),{_theme:t,_colorMap:s}}function b(e,t="text",s,a={includeExplanation:!0}){if(function(e){return!e||["plaintext","txt","text"].includes(e)}(t))return[...e.split(/\r\n|\r|\n/).map((e=>[{content:e}]))]
const{_grammar:r}=function(e){const t=l.getGrammar(e)
if(!t)throw Error(`No language registration for ${e}`)
return{_grammar:t}}(t),{_theme:o,_colorMap:i}=y(s)
return function(e,t,s,a,r){let o=s.split(/\r\n|\r|\n/),i=n.INITIAL,c=[],l=[]
for(let n=0,u=o.length;n<u;n++){let s,u,p,m=o[n]
if(""===m){c=[],l.push([])
continue}r.includeExplanation&&(s=a.tokenizeLine(m,i),u=s.tokens,p=0)
let d=a.tokenizeLine2(m,i),g=d.tokens.length/2
for(let a=0;a<g;a++){let s=d.tokens[2*a],n=a+1<g?d.tokens[2*a+2]:m.length
if(s===n)continue
let o=d.tokens[2*a+1],i=t[h.getForeground(o)],l=h.getFontStyle(o),f=[]
if(r.includeExplanation){let t=0
for(;s+t<n;){let s=u[p],a=m.substring(s.startIndex,s.endIndex)
t+=a.length,f.push({content:a,scopes:D(e,s.scopes)}),p++}}c.push({content:m.substring(s,n),color:i,fontStyle:l,explanation:f})}l.push(c),c=[],i=d.ruleStack}return l}(o,i,e,r,a)}function _(e,t){const{_theme:s}=y(t)
return function(e,t){const s=t.split(/\r?\n/),a=function(e=J){function t(t){return e[t]}function s(e){return`#${e.map((e=>Math.max(0,Math.min(e,255)).toString(16).padStart(2,"0"))).join("")}`}let a
return{value:function(e){switch(e.type){case"named":return t(e.name)
case"rgb":return s(e.rgb)
case"table":return n=e.index,function(){if(a)return a
a=[]
for(let s=0;s<q.length;s++)a.push(t(q[s]))
let e=[0,95,135,175,215,255]
for(let t=0;t<6;t++)for(let n=0;n<6;n++)for(let r=0;r<6;r++)a.push(s([e[t],e[n],e[r]]))
let n=8
for(let t=0;t<24;t++,n+=10)a.push(s([n,n,n]))
return a}()[n]}var n}}}(Object.fromEntries(q.map((t=>[t,e.colors[`terminal.ansi${t[0].toUpperCase()}${t.substring(1)}`]])))),n=function(){let e=null,t=null,s=new Set
...
let n=p.None
return t.decorations.has("bold")&&(n|=p.Bold),t.decorations.has("italic")&&(n|=p.Italic),t.decorations.has("underline")&&(n|=p.Underline),{content:t.value,color:s,fontStyle:n}}))))}(s,e)}return{codeToThemedTokens:b,codeToHtml:function(e,t="text",s){let a
a="object"==typeof t?t:{lang:t,theme:s}
const n=b(e,a.lang,a.theme,{includeExplanation:!1}),{_theme:r}=y(a.theme)
return X(n,{fg:r.fg,bg:r.bg,lineOptions:a?.lineOptions,themeName:r.name})},ansiToThemedTokens:_,ansiToHtml:function(e,t){const s=_(e,t?.theme),{_theme:a}=y(t?.theme)
return X(s,{fg:a.fg,bg:a.bg,lineOptions:t?.lineOptions,themeName:a.name})},getTheme:e=>y(e)._theme,loadTheme:async function(e){await l.loadTheme(e)},loadLanguage:async function(e){const t=ee(e)
c.addLanguage(t),await l.loadLanguage(t)},getBackgroundColor:function(e){const{_theme:t}=y(e)
return t.bg},getForegroundColor:function(e){const{_theme:t}=y(e)
return t.fg},getLoadedThemes:function(){return l.getLoadedThemes()},getLoadedLanguages:function(){return l.getLoadedLanguages()},setColorReplacements:function(e){d=e}}}function se(e){A(e)}},3616:function(e){var t
...
t>=56320&&t<=57343&&(l=65536+(s-55296<<10)|t-56320,u=!0)}a&&(n[i]=c,u&&(n[i+1]=c),l<=127?r[c+0]=i:l<=2047?(r[c+0]=i,r[c+1]=i):l<=65535?(r[c+0]=i,r[c+1]=i,r[c+2]=i):(r[c+0]=i,r[c+1]=i,r[c+2]=i,r[c+3]=i)),l<=127?o[c++]=l:l<=2047?(o[c++]=192|(1984&l)>>>6,o[c++]=128|(63&l)>>>0):l<=65535?(o[c++]=224|(61440&l)>>>12,o[c++]=128|(4032&l)>>>6,o[c++]=128|(63&l)>>>0):(o[c++]=240|(1835008&l)>>>18,o[c++]=128|(258048&l)>>>12,o[c++]=128|(4032&l)>>>6,o[c++]=128|(63&l)>>>0),u&&i++}this.utf16Length=t,this.utf8Length=s,this.utf16Value=e,this.utf8Value=o,this.utf16OffsetToUtf8=n,this.utf8OffsetToUtf16=r}createString(e){const t=e._omalloc(this.utf8Length)
...
const t=[],s=[]
for(let c=0,l=e.length;c<l;c++){const a=new i(e[c])
t[c]=a.createString(r),s[c]=a.utf8Length}const a=r._omalloc(4*e.length)
r.HEAPU32.set(t,a/4)
...
if("number"==typeof s?(8&s&&(a=!0),n=s):"boolean"==typeof s&&(a=s),"string"==typeof e){e=new c(e)
...
var i,c,l=a.print||console.log.bind(console),u=a.printErr||console.warn.bind(console)
Object.assign(a,r),r=null,a.arguments&&(o=a.arguments),a.thisProgram&&a.thisProgram,a.quit&&a.quit,a.wasmBinary&&(i=a.wasmBinary),a.noExitRuntime,"object"!=typeof WebAssembly&&w("no native wasm support detected")
var p,h,m,d=!1,g="undefined"!=typeof TextDecoder?new TextDecoder("utf8"):void 0
function f(e,t,s){for(var a=t+s,n=t;e[n]&&!(n>=a);)++n
...
console.log({languageId:t,tokenType:a,fontStyle:n,foreground:r,background:o})},s.getLanguageId=function(e){return(255&e)>>>0},s.getTokenType=function(e){return(768&e)>>>8},s.containsBalancedBrackets=function(e){return!!(1024&e)},s.getFontStyle=function(e){return(30720&e)>>>11},s.getForeground=function(e){return(16744448&e)>>>15},s.getBackground=function(e){return(4278190080&e)>>>24},s.set=function(e,t,a,n,r,o,i){let c=s.getLanguageId(e),l=s.getTokenType(e),u=s.containsBalancedBrackets(e)?1:0,p=s.getFontStyle(e),h=s.getForeground(e),m=s.getBackground(e)
return 0!==t&&(c=t),8!==a&&(l=a),null!==n&&(u=n?1:0),-1!==r&&(p=r),0!==o&&(h=o),0!==i&&(m=i),(c|l<<8|u<<10|p<<11|h<<15|m<<24)>>>0},t.toOptionalTokenType=function(e){return e}},996:(e,t,s)=>{Object.defineProperty(t,"__esModule",{value:!0}),t.BasicScopeAttributesProvider=t.BasicScopeAttributes=void 0
const a=s(878)
...
const a=s(350),n=s(36),r=s(736),o=s(44),i=s(792),c=s(583),l=s(878),u=s(996),p=s(47)
function h(e,t,s,a,n){const o=r.createMatchers(t,m),c=i.RuleFactory.getCompiledRuleId(s,a,n.repository)
for(const r of o)e.push({debugSelector:t,matcher:r.matcher,ruleId:c,grammar:n,priority:r.priority})}function m(e,t){if(t.length<e.length)return!1
let s=0
...
class g{constructor(e,t,s,a,n,o,i,c){if(this._rootScopeName=e,this.balancedBracketSelectors=o,this._onigLib=c,this._basicScopeAttributesProvider=new u.BasicScopeAttributesProvider(s,a),this._rootId=-1,this._lastRuleId=0,this._ruleId2desc=[null],this._includedGrammars={},this._grammarRepository=i,this._grammar=f(t,null),this._injections=null,this._tokenTypeMatchers=[],n)for(const l of Object.keys(n)){const e=r.createMatchers(l,m)
for(const t of e)this._tokenTypeMatchers.push({matcher:t.matcher,type:n[l]})}}get themeProvider(){return this._grammarRepository}dispose(){for(const e of this._ruleId2desc)e&&e.dispose()}createOnigScanner(e){return this._onigLib.createOnigScanner(e)}createOnigString(e){return this._onigLib.createOnigString(e)}getMetadataForScope(e){return this._basicScopeAttributesProvider.getBasicScopeAttributes(e)}_collectInjections(){const e=[],t=this._rootScopeName,s=(e=>e===this._rootScopeName?this._grammar:this.getExternalGrammar(e))(t)
...
if(s)return this._includedGrammars[e]=f(s,t&&t.$base),this._includedGrammars[e]}}tokenizeLine(e,t,s=0){const a=this._tokenize(e,t,!1,s)
return{tokens:a.lineTokens.getResult(a.ruleStack,a.lineLength),ruleStack:a.ruleStack,stoppedEarly:a.stoppedEarly}}tokenizeLine2(e,t,s=0){const a=this._tokenize(e,t,!0,s)
...
const c=this.createOnigString(e),l=c.content.length,u=new _(s,e,this._tokenTypeMatchers,this.balancedBracketSelectors),h=p._tokenizeString(this,c,r,0,t,u,!0,a)
...
class y{constructor(e,t,s){this.parent=e,this.scopePath=t,this.tokenAttributes=s}static createRoot(e,t){return new y(null,new c.ScopeStack(null,e),t)}static createRootAndLookUpScopeName(e,t,s){const a=s.getMetadataForScope(e),n=new c.ScopeStack(null,e),r=s.themeProvider.themeMatch(n),o=y.mergeAttributes(t,a,r)
...
class i{constructor(e,t){this.stack=e,this.stoppedEarly=t}}function c(e,t,s,n,c,p,m,d){const g=t.content.length
let f=!1,y=-1
if(m){const o=function(e,t,s,n,o,i){let c=o.beginRuleCapturedEOL?0:-1
const l=[]
for(let a=o;a;a=a.pop()){const t=a.getRule(e)
t instanceof r.BeginWhileRule&&l.push({rule:t,stack:a})}for(let p=l.pop();p;p=l.pop()){const{ruleScanner:l,findOptions:m}=u(p.rule,e,p.stack.endRule,s,n===c),d=l.findNextMatchSync(t,n,m)
if(a.DebugFlags.InDebugMode&&(console.log("  scanning for while rule"),console.log(l.toString())),!d){a.DebugFlags.InDebugMode&&console.log("  popping "+p.rule.debugName+" - "+p.rule.debugWhileRegExp),o=p.stack.pop()
break}if(d.ruleId!==r.whileRuleId){o=p.stack.pop()
break}d.captureIndices&&d.captureIndices.length&&(i.produce(p.stack,d.captureIndices[0].start),h(e,t,s,p.stack,i,p.rule.whileCaptures,d.captureIndices),i.produce(p.stack,d.captureIndices[0].end),c=d.captureIndices[0].end,d.captureIndices[0].end>n&&(n=d.captureIndices[0].end,s=!1))}return{stack:o,linePos:n,anchorPosition:c,isFirstLine:s}}(e,t,s,n,c,p)
c=o.stack,n=o.linePos,s=o.isFirstLine,y=o.anchorPosition}const b=Date.now()
for(;!f;){if(0!==d&&Date.now()-b>d)return new i(c,!0)
_()}return new i(c,!1)
function _(){a.DebugFlags.InDebugMode&&(console.log(""),console.log(`@@scanNext ${n}: |${t.content.substr(n).replace(/\n$/,"\\n")}|`))
const i=function(e,t,s,n,r,i){const c=function(e,t,s,n,r,i){const c=r.getRule(e),{ruleScanner:u,findOptions:p}=l(c,e,r.endRule,s,n===i)
let h=0
...
const p=function(e,t,s,n,r,o,i){let c,u=Number.MAX_VALUE,p=null,h=0
const m=o.contentNameScopesList.getScopeNames()
for(let d=0,g=e.length;d<g;d++){const o=e[d]
if(!o.matcher(m))continue
const g=t.getRule(o.ruleId),{ruleScanner:f,findOptions:y}=l(g,t,null,n,r===i),b=f.findNextMatchSync(s,r,y)
if(!b)continue
...
if(!(_>=u)&&(u=_,p=b.captureIndices,c=b.ruleId,h=o.priority,u===r))break}return p?{priorityMatch:-1===h,captureIndices:p,matchedRuleId:c}:null}(u,e,t,s,n,r,i)
if(!p)return c
if(!c)return p
const h=c.captureIndices[0].start,m=p.captureIndices[0].start
return m<h||p.priorityMatch&&m===h?p:c}(e,t,s,n,c,y)
if(!i)return a.DebugFlags.InDebugMode&&console.log("  no more matches."),p.produce(c,g),void(f=!0)
const u=i.captureIndices,m=i.matchedRuleId,d=!!(u&&u.length>0)&&u[0].end>n
if(m===r.endRuleId){const r=c.getRule(e)
a.DebugFlags.InDebugMode&&console.log("  popping "+r.debugName+" - "+r.debugEndRegExp),p.produce(c,u[0].start),c=c.withContentNameScopesList(c.nameScopesList),h(e,t,s,c,p,r.endCaptures,u),p.produce(c,u[0].end)
const o=c
if(c=c.parent,y=o.getAnchorPos(),!d&&o.getEnterPos()===n)return a.DebugFlags.InDebugMode&&console.error("[1] - Grammar is in an endless loop - Grammar pushed & popped a rule without advancing"),c=o,p.produce(c,g),void(f=!0)}else{const o=e.getRule(m)
p.produce(c,u[0].start)
const i=c,l=o.getName(t.content,u),b=c.contentNameScopesList.pushAttributed(l,e)
if(c=c.push(m,n,y,u[0].end===g,null,b,b),o instanceof r.BeginEndRule){const n=o
a.DebugFlags.InDebugMode&&console.log("  pushing "+n.debugName+" - "+n.debugBeginRegExp),h(e,t,s,c,p,n.beginCaptures,u),p.produce(c,u[0].end),y=u[0].end
const r=n.getContentName(t.content,u),l=b.pushAttributed(r,e)
...
a.DebugFlags.InDebugMode&&console.log("  pushing "+n.debugName),h(e,t,s,c,p,n.beginCaptures,u),p.produce(c,u[0].end),y=u[0].end
const r=n.getContentName(t.content,u),l=b.pushAttributed(r,e)
...
p.push(new m(t,u.end))}}for(;p.length>0;)r.produceFromScopes(p[p.length-1].scopes,p[p.length-1].endPos),p.pop()}t._tokenizeString=c
class m{constructor(e,t){this.scopes=e,this.endPos=t}}t.LocalStackElement=m},974:(e,t)=>{function s(e,t){throw new Error("Near offset "+e.pos+": "+t+" ~~~"+e.source.substr(e.pos,50)+"~~~")}Object.defineProperty(t,"__esModule",{value:!0}),t.parseJSON=void 0,t.parseJSON=function(e,t,o){let i=new a(e),c=new n,l=0,u=null,p=[],h=[]
function m(){p.push(l),h.push(u)}function d(){l=p.pop(),u=h.pop()}function g(e){s(i,e)}for(;r(i,c);){if(0===l){if(null!==u&&g("too many constructs in root"),3===c.type){u={},o&&(u.$vscodeTextmateLocation=c.toLocation(t)),m(),l=1
continue}if(2===c.type){u=[],m(),l=4
continue}g("unexpected token in root")}if(2===l){if(5===c.type){d()
continue}if(7===c.type){l=3
continue}g("expected , or }")}if(1===l||3===l){if(1===l&&5===c.type){d()
...
o&&(s.$vscodeTextmateLocation=c.toLocation(t)),u[e]=s,m(),l=1,u=s
continue}}g("unexpected token in dict")}if(5===l){if(4===c.type){d()
continue}if(7===c.type){l=6
continue}g("expected , or ]")}if(4===l||6===l){if(4===l&&4===c.type){d()
...
o&&(e.$vscodeTextmateLocation=c.toLocation(t)),u.push(e),m(),l=1,u=e
...
let a,n=e.source,r=e.pos,o=e.len,i=e.line,c=e.char
for(;;){if(r>=o)return!1
if(a=n.charCodeAt(r),32!==a&&9!==a&&13!==a){if(10!==a)break
r++,i++,c=0}else r++,c++}if(t.offset=r,t.line=i,t.char=c,34===a){for(t.type=1,r++,c++;;){if(r>=o)return!1
if(a=n.charCodeAt(r),r++,c++,92!==a){if(34===a)break}else r++,c++}t.value=n.substring(t.offset+1,r-1).replace(/\\u([0-9A-Fa-f]{4})/g,((e,t)=>String.fromCodePoint(parseInt(t,16)))).replace(/\\(.)/g,((t,a)=>{switch(a){case'"':return'"'
case"\\":return"\\"
case"/":return"/"
case"b":return"\b"
case"f":return"\f"
...
case"r":return"\r"
case"t":return"\t"
default:s(e,"invalid escape sequence")}throw new Error("unreachable")}))}else if(91===a)t.type=2,r++,c++
...
else if(110===a){if(t.type=8,r++,c++,a=n.charCodeAt(r),117!==a)return!1
if(r++,c++,a=n.charCodeAt(r),108!==a)return!1
if(r++,c++,a=n.charCodeAt(r),108!==a)return!1
r++,c++}else if(116===a){if(t.type=9,r++,c++,a=n.charCodeAt(r),114!==a)return!1
if(r++,c++,a=n.charCodeAt(r),117!==a)return!1
if(r++,c++,a=n.charCodeAt(r),101!==a)return!1
r++,c++}else if(102===a){if(t.type=10,r++,c++,a=n.charCodeAt(r),97!==a)return!1
if(r++,c++,a=n.charCodeAt(r),108!==a)return!1
...
t.parseRawGrammar=function(e,t=null){return null!==t&&/\.json$/.test(t)?(s=e,o=t,n.DebugFlags.InDebugMode?r.parseJSON(s,o,!0):JSON.parse(s)):function(e,t){return n.DebugFlags.InDebugMode?a.parseWithLocation(e,t,"$vscodeTextmateLocation"):a.parsePLIST(e)}(e,t)
var s,o}},69:(e,t)=>{function s(e,t,s){const a=e.length
let n=0,r=1,o=0
function i(t){if(null===s)n+=t
else for(;t>0;)10===e.charCodeAt(n)?(n++,r++,o=0):(n++,o++),t--}function c(e){null===s?n=e:i(e-n)}function l(){for(;n<a;){let t=e.charCodeAt(n)
if(32!==t&&9!==t&&13!==t&&10!==t)break
i(1)}}function u(t){return e.substr(n,t.length)===t&&(i(t.length),!0)}function p(t){let s=e.indexOf(t,n)
c(-1!==s?s+t.length:a)}function h(t){let s=e.indexOf(t,n)
if(-1!==s){let a=e.substring(n,s)
return c(s+t.length),a}{let t=e.substr(n)
return c(a),t}}a>0&&65279===e.charCodeAt(0)&&(n=1)
...
null!==s&&(e[s]={filename:t,line:r,char:o}),d.push(e),b(1,e)},P=function(){let e=[]
d.push(e),b(2,e)}
function v(){if(1!==m)return N("unexpected </dict>")
_()}function j(){return 1===m||2!==m?N("unexpected </array>"):void _()}function C(e){if(1===m){if(null===y)return N("missing <key>")
d[y]=e,y=null}else 2===m?d.push(e):d=e}function w(e){if(isNaN(e))return N("cannot parse float")
...
case"&gt;":return">"
case"&quot;":return'"'
case"&apos;":return"'"}return e}))}for(;n<a&&(l(),!(n>=a));){const c=e.charCodeAt(n)
...
continue}if(u("dict")){p(">"),v()
continue}if(u("array")){p(">"),j()
continue}return N("unexpected closed tag")}let g=I()
switch(g.name){case"dict":1===m?k():2===m?S():(d={},null!==s&&(d[s]={filename:t,line:r,char:o}),b(1,d)),g.isClosed&&v()
continue
case"array":1===m?L():2===m?P():(d=[],b(2,d)),g.isClosed&&j()
continue
case"key":O=E(g),1!==m?N("unexpected <key>"):null!==y?N("too many <key>"):y=O
continue
case"string":C(E(g))
continue
case"real":w(parseFloat(E(g)))
continue
...
class c extends i{constructor(e,t,s,a,n){super(e,t,s,a),this.retokenizeCapturedWithRuleId=n}dispose(){}collectPatterns(e,t){throw new Error("Not supported!")}compile(e,t){throw new Error("Not supported!")}compileAG(e,t,s,a){throw new Error("Not supported!")}}t.CaptureRule=c
class l extends i{constructor(e,t,s,a,n){super(e,t,s,null),this._match=new d(a,this.id),this.captures=n,this._cachedCompiledPatterns=null}dispose(){this._cachedCompiledPatterns&&(this._cachedCompiledPatterns.dispose(),this._cachedCompiledPatterns=null)}get debugMatchRegExp(){return`${this._match.source}`}collectPatterns(e,t){t.push(this._match)}compile(e,t){return this._getCachedCompiledPatterns(e).compile(e)}compileAG(e,t,s,a){return this._getCachedCompiledPatterns(e).compileAG(e,s,a)}_getCachedCompiledPatterns(e){return this._cachedCompiledPatterns||(this._cachedCompiledPatterns=new g,this.collectPatterns(e,this._cachedCompiledPatterns)),this._cachedCompiledPatterns}}t.MatchRule=l
...
class m{static createCaptureRule(e,t,s,a,n){return e.registerRule((e=>new c(t,e,s,a,n)))}static getCompiledRuleId(e,t,s){return e.id||t.registerRule((n=>{if(e.id=n,e.match)return new l(e.$vscodeTextmateLocation,e.id,e.name,e.match,m._compileCaptures(e.captures,t,s))
...
break
case 3:case 4:const n=e.scopeName,r=4===e.kind?e.ruleName:null,c=t.getExternalGrammar(n,s)
if(c)if(r){let e=c.repository[r]
e&&(i=m.getCompiledRuleId(e,t,c.repository))}else i=m.getCompiledRuleId(c.repository.$self,t,c.repository)}}else i=m.getCompiledRuleId(o,t,s)
...
const a=s(878)
class n{constructor(e,t,s){this._colorMap=e,this._defaults=t,this._root=s,this._cachedMatchRoot=new a.CachedFn((e=>this._root.match(e)))}static createFromRawTheme(e,t){return this.createFromParsedTheme(c(e),t)}static createFromParsedTheme(e,t){return function(e,t){e.sort(((e,t)=>{let s=a.strcmp(e.scope,t.scope)
return 0!==s?s:(s=a.strArrCmp(e.parentScopes,t.parentScopes),0!==s?s:e.index-t.index)}))
let s=0,r="#000000",o="#ffffff"
for(;e.length>=1&&""===e[0].scope;){let t=e.shift();-1!==t.fontStyle&&(s=t.fontStyle),null!==t.foreground&&(r=t.foreground),null!==t.background&&(o=t.background)}let c=new u(t),l=new i(s,c.getId(r),c.getId(o)),m=new h(new p(0,null,-1,0,0),[])
for(let a=0,n=e.length;a<n;a++){let t=e[a]
m.insert(0,t.scope,t.parentScopes,t.fontStyle,c.getId(t.foreground),c.getId(t.background))}return new n(c,l,m)}(e,t)}getColorMap(){return this._colorMap.getColorMap()}getDefaults(){return this._defaults}match(e){if(null===e)return this._defaults
...
class r{constructor(e,t){this.parent=e,this.scopeName=t}static from(...e){let t=null
for(let s=0;s<e.length;s++)t=new r(t,e[s])
return t}push(e){return new r(this,e)}getSegments(){let e=this
const t=[]
...
"string"==typeof o.settings.foreground&&a.isValidHexColor(o.settings.foreground)&&(c=o.settings.foreground)
let u=null
...
a.length>1&&(p=a.slice(0,a.length-1),p.reverse()),s[n++]=new l(o,p,r,i,c,u)}}return s}t.StyleAttributes=i,t.parseTheme=c
class l{constructor(e,t,s,a,n,r){this.scope=e,this.parentScopes=t,this.index=s,this.fontStyle=a,this.foreground=n,this.background=r}}t.ParsedThemeRule=l,t.fontStyleToString=function(e){if(-1===e)return"not set"
let t=""
...
class h{constructor(e,t=[],s={}){this._mainRule=e,this._children=s,this._rulesWithParentScopes=t}static _sortBySpecificity(e){return 1===e.length||e.sort(this._cmpBySpecificity),e}static _cmpBySpecificity(e,t){if(e.scopeDepth===t.scopeDepth){const s=e.parentScopes,a=t.parentScopes
...
let o,i,c,l=t.indexOf(".");-1===l?(o=t,i=""):(o=t.substring(0,l),i=t.substring(l+1)),this._children.hasOwnProperty(o)?c=this._children[o]:(c=new h(this._mainRule.clone(),p.cloneArr(this._rulesWithParentScopes)),this._children[o]=c),c.insert(e+1,i,s,a,n,r)}_doInsertHere(e,t,s,n,r){if(null!==t){for(let o=0,i=this._rulesWithParentScopes.length;o<i;o++){let i=this._rulesWithParentScopes[o]
...
return t}(e):e}Object.defineProperty(t,"__esModule",{value:!0}),t.performanceNow=t.CachedFn=t.escapeRegExpCharacters=t.isValidHexColor=t.strArrCmp=t.strcmp=t.RegexSource=t.basename=t.mergeObjects=t.clone=void 0,t.clone=function(e){return s(e)},t.mergeObjects=function(e,...t){return t.forEach((t=>{for(let s in t)e[s]=t[s]})),e},t.basename=function e(t){const s=~t.lastIndexOf("/")||~t.lastIndexOf("\\")
