...
var a,c,u,l,m,b,p,d,h,f,g,y,v,_,j,k=t.n(s),x=t(1130),O=t(1223),w=t(473),q=(t(3528),t(1603))
function E(e){const{classes:r,disabled:t,label:i,secondary:n,text:o,type:s}=e
return s?((0,q.assert)("'type' property must be one of 'back', 'cancel', or 'next'",["back","cancel","next"].includes(s)),{action:(0,O.bind)(this,(function(){this[s]()})),classes:r,disabled:t,label:i,secondary:n,text:o,type:s}):e}function C(e,r,t,i,n){var o={}
return Object.keys(i).forEach((function(e){o[e]=i[e]})),o.enumerable=!!o.enumerable,o.configurable=!!o.configurable,("value"in o||o.initializer)&&(o.writable=!0),o=t.slice().reverse().reduce((function(t,i){return i(e,r,t)||t}),o),void 0===o.initializer?(Object.defineProperty(e,r,o),null):o}function z(e,r,t,i){t&&Object.defineProperty(e,r,{enumerable:t.enumerable,configurable:t.configurable,writable:t.writable,value:t.initializer?t.initializer.call(i):void 0})}let S=(a=class extends(o().extend(k())){constructor(e){super(e),z(this,"classPrefix",c,this),z(this,"confirmCancel",u,this),z(this,"confirmCancelMessage",l,this),z(this,"defaultStepOptions",m,this),z(this,"errorTitle",b,this),z(this,"exitOnEsc",p,this),z(this,"isActive",d,this),z(this,"keyboardNavigation",h,this),z(this,"messageForUser",f,this),z(this,"modal",g,this),z(this,"modalContainer",y,this),z(this,"requiredElements",v,this),z(this,"stepsContainer",_,this),z(this,"tourObject",j,this),(0,x.registerDestructor)(this,(()=>this.tourObject.cancel()))}addSteps(e){return this._initialize().then((()=>{const r=this.tourObject;(0,i.isEmpty)(e)||(this._requiredElementsPresent()?e.forEach((e=>{e.buttons&&(e.buttons=e.buttons.map(E.bind(this),this)),r.addStep(e)})):r.addStep({buttons:[{text:"Exit",action:r.cancel}],id:"error",title:this.errorTitle,text:this.messageForUser}))}))}back(){this.tourObject.back(),this.trigger("back")}cancel(){this.tourObject.cancel()}complete(){this.tourObject.complete()}hide(){this.tourObject.hide()}next(){this.tourObject.next(),this.trigger("next")}show(e){this.tourObject.show(e)}start(){const e=this.tourObject
...
m.on("start",(0,O.bind)(this,"_onTourStart")),m.on("complete",(0,O.bind)(this,"_onTourFinish","complete")),m.on("cancel",(0,O.bind)(this,"_onTourFinish","cancel")),this.tourObject=m}))}_requiredElementsPresent(){let e=!0
const r=this.requiredElements
return(0,i.isPresent)(r)&&r.forEach((r=>{const t=document.querySelector(r.selector)
!e||t&&!function(e){return 0===e.offsetWidth&&0===e.offsetHeight}(t)||(e=!1,this.errorTitle=r.title,this.messageForUser=r.message)})),e}},c=C(a.prototype,"classPrefix",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),u=C(a.prototype,"confirmCancel",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),l=C(a.prototype,"confirmCancelMessage",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),m=C(a.prototype,"defaultStepOptions",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return{}}}),b=C(a.prototype,"errorTitle",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),p=C(a.prototype,"exitOnEsc",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),d=C(a.prototype,"isActive",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),h=C(a.prototype,"keyboardNavigation",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),f=C(a.prototype,"messageForUser",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),g=C(a.prototype,"modal",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),y=C(a.prototype,"modalContainer",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),v=C(a.prototype,"requiredElements",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return[]}}),_=C(a.prototype,"stepsContainer",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),j=C(a.prototype,"tourObject",[w.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),a)},4463:e=>{"use strict"
...
var e})),void t(8873))},715:(e,r,t)=>{"use strict"
...
t.forEach(r.bind(null,0)),t.push=r.bind(null,t.push.bind(t))})(),o.O(void 0,[994],(()=>o(796)))
var s=o.O(void 0,[994],(()=>o(6231)))
